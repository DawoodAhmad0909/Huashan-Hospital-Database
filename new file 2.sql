...
SELECT * FROM Doctors
WHERE 
	specialization LIKE 'AI%'
OR specialization LIKE '%AI%'
OR specialization LIKE '%AI';
...
OR insurance_provider LIKE '%CARE'
OR insurance_provider LIKE '%CARE%';
...
SELECT gender,COUNT(*) AS Total_Patients, COUNT(*)*100/(SELECT COUNT(*)FROM Patients) AS Percentage FROM Patients
GROUP BY gender;
